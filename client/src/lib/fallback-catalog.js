// Client-side fallback catalog. The 16 fragrances from the original static
// site's catalog.js, mirrored here so the UI is never empty when:
//   - The backend isn't running (local dev without `npm run dev:server`)
//   - The database isn't seeded
//   - The API is reachable but returns 0 rows
...
//
// `description` is editorial copy in the brand voice. Short. Verb-first when
// possible. Notes named directly. No reviewer clichés ("settles into",
// "lingers on", "magnificent"). When a fragrance lacks a description, the
// FragrancePage falls back to a less-templated synthesis.
//
...
export const FALLBACK_CATALOG = [
  ...
  { id: 2,  name: 'Baccarat Rouge 540',   brand: 'MFK',                 type: 'niche',    family: 'Oriental', top: 'Jasmine, Saffron',             heart: 'Amberwood, Ambergris',       base: 'Fir Resin, Cedar',            season: ['Fall','Winter'],                    time: ['Evening','Night'],                              mood: ['Romantic','Confident'], bg: 'p-bg-4',  badge: 'SOTW',
    description: 'Saffron and jasmine signal something is about to happen. Ambroxan delivers — it glows on skin like firelight, hours past the spray. Polarizing. Never forgettable.', imageUrl: 'https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=1200&h=1200&fit=crop&q=80' },
