...
const GLOSSARY = [
  ...
  { term: 'Dry-down', def: 'The final phase of a fragrance after it has fully settled on skin, the base notes. How a fragrance smells 30 to 60 minutes after application.' },
      ...
      {tab === 'concentration' && (
        <div className="ext-page">
          ...
          <div className="conc-grid">
            <ConcentrationCard type="EDC"     full="Eau de Cologne"          bar={12}  oil="2 to 4%"   longevity="1 to 2 hours"   projection="Light"     bestFor="Hot weather, gym"       desc="The lightest concentration. Fresh, fleeting, and perfect for casual use when you don't need lasting power." examples={['4711 Original Eau de Cologne','Acqua di Parma Colonia']} />
            <ConcentrationCard type="EDT"     full="Eau de Toilette"         bar={32}  oil="5 to 15%"  longevity="3 to 5 hours"   projection="Moderate"  bestFor="Daily wear, office"     desc="The most popular concentration. Versatile and appropriate for almost any setting. Most designer releases live here." examples={['Dior Sauvage EDT','Creed Aventus EDT']} />
            <ConcentrationCard type="EDP"     full="Eau de Parfum"           bar={62}  oil="15 to 20%" longevity="6 to 8 hours"   projection="Strong"    bestFor="Evenings, occasions"    desc="Richer and longer-lasting. Base notes get more development time. Where most niche houses operate." examples={['Dior Sauvage EDP','YSL Black Opium EDP']} />
            <ConcentrationCard type="Parfum"  full="Pure Parfum / Extrait"  bar={100} oil="20 to 40%" longevity="10 to 24 hours" projection="Intimate"  bestFor="Special occasions"      desc="The most concentrated form. Fewer sprays needed, stays close to skin, lasts into the next morning. A luxury experience." examples={['Chanel No.5 Parfum','Tom Ford Noir Extreme Parfum']} />
          </div>
        </div>
      )}
          ...
          <div className="sourcing-process">
            ...
            <div className="sourcing-process-col">
              ...
              <ol className="sourcing-steps-list">
                ...
                <li><span className="sourcing-step-tag">02</span><div><strong>We find it through our network</strong>, boutique distributors, parallel-import suppliers, brand-direct contacts. We aim for 20 to 40% below manufacturer retail, but availability and pricing vary by bottle.</div></li>
